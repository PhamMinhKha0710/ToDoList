...
class PersonalTaskController {
  ...
  updatePersonalTask = catchAsync(async (req, res) => {
    ...
    new ApiResponse(200, 'Cập nhật công việc cá nhân thành công', { task }).send(res);
  });
