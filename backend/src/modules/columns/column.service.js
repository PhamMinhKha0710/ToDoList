class ColumnService {
  ...
  async updateColumn(columnId, updateData) {
    ...
    return this.columnRepository.updateById(columnId, updateData);
  }
  ...
  async reorderColumns(projectId, orderedColumnIds) {
    ...
    return this.Column.find({ projectId }).sort({ position: 1 });
  }
}

module.exports = new ColumnService({
  columnRepository: require('./column.repository'),
