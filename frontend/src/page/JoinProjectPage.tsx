...
const JoinProjectPage = () => {
  ...
  if (error || !response?.data?.project) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6">
        <div className="max-w-md w-full bg-white rounded-3xl p-10 shadow-xl border border-red-50 text-center space-y-6">
          <div className="w-20 h-20 bg-red-100 rounded-full flex items-center justify-center mx-auto">
            < ShieldCheck className="h-10 w-10 text-red-500 opacity-50" />
          </div>
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-6">
      <div className="max-w-[480px] w-full bg-white rounded-[2rem] shadow-2xl shadow-indigo-100/50 border border-slate-100 overflow-hidden">
        {/* Header/Cover color */}
        <div 
        ...
        <div className="px-8 pb-10 -mt-12">
          <div className="flex flex-col items-center text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-slate-500 text-sm line-clamp-2 max-w-[320px] mx-auto">
            ...
            <div className="w-full space-y-4 pt-4">
              <Button 
                className="w-full h-14 rounded-2xl bg-indigo-600 hover:bg-slate-900 text-white font-bold text-lg shadow-xl shadow-indigo-100 transition-all hover:scale-[1.02] active:scale-95 group"
        ...
        {/* Footer info */}
        <div className="bg-slate-50/50 p-6 flex flex-col items-center border-t border-slate-100 gap-3">
