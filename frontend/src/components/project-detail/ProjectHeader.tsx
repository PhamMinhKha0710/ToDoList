...
import { ArrowLeft, Edit, Settings, Users, Trash2, ShieldAlert } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export const ProjectHeader = ({ project }: ProjectHeaderProps) => {
  ...
  const remainingMembersCount = project.members.length - membersToDisplay.length;
          ...
          >
            <div className="flex -space-x-2 mr-1">
              {membersToDisplay.map((member) => {
                ...
                return (
                  <Avatar key={user._id} className="h-7 w-7 border-2 border-background">
        ...
        <DialogContent className="sm:max-w-[400px]">
          <DialogHeader>
            ...
            <DialogDescription className="py-4">
              ...
              không? Hành động này không thể hoàn tác và tất cả dữ liệu sẽ bị mất.
            </DialogDescription>
          </DialogHeader>
